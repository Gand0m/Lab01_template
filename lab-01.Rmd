...
NA stands for not available and this is an answer because some of the statistics for the number of visitors for some attractions in 2021 is not listed/ not available
...
Mean represents average data whereas median is the middle value, as there exist attractions where the number of visitors is NA, this drags down the median.
